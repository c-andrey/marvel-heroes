...
class ListHeroesApiTest extends TestCase
{
    /**
     * Should list heroes from the remote api.
     */
    public function test_list_heroes_remote(): void
    {
        ...
        Http::fake([
            $url => Http::response([
                'data' => [
                    ...
                    "etag" =>  "0fd8927eeee2d2a3ba15ce81471f09dc5cacb45e",
                    "data" =>  [
                        "offset" =>  0,
                        "limit" =>  5,
                        "total" =>  1562,
                        ...
                        "results" =>  [
                            [
                                ...
                                "urls" =>  [
                                    [
                                        "type" =>  "detail",
                                        "url" =>  "http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=f45f3dccfd10b2b6d7e9df21613eb34a"
                                    ],
                                    [
                                        "type" =>  "wiki",
                                        "url" =>  "http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=f45f3dccfd10b2b6d7e9df21613eb34a"
                                    ],
                                    [
                                        "type" =>  "comiclink",
                                        "url" =>  "http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=f45f3dccfd10b2b6d7e9df21613eb34a"
        ...
        $heroesRemoteService = new HeroesRemoteService();

        $response = $heroesRemoteService->getHeroes();
        ...
        $this->assertCount(1, $content['data']['results']);
    }
}
